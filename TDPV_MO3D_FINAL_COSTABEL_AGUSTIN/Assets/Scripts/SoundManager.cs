...
public class SoundManager : MonoBehaviour
{
    ...
    public void Fireball() {
        PlaySound(audioClipsSO.fireball, Camera.main.transform.position, 0.7f);
    }

    public void EnemyHit() {
        PlaySound(audioClipsSO.enemyHit, Camera.main.transform.position, 0.7f);
    }

    public void PlayVictory() {
        PlaySound(audioClipsSO.victory, Camera.main.transform.position, 0.7f);
    }
